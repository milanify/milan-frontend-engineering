...
Conversations also evolve over time. Sometimes I have new conversations that are adjacant to previous conversations that I can't map cleanly in Apple Notes. Certain threads become more useful, others drift. But there’s no clean way to query, version, or organize that evolution. [I even asked ChatGPT for possible solutions to this problem — here is a link to it's response.](knowledge-organization-idea.md)
